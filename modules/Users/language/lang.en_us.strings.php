...
LBL_SUGAR_LOGIN: Is info@hand Login
...
LBL_GOOGLE_CALENDAR_ID_EXPLANATION:
	Leave Google Calendar ID blank if you want to sync your main calendar. If you have additional calendars,<br>you can sync with one of them. In this case, enter Google calendar ID to this field.
...
LBL_GOOGLE_CALENDAR_LAST_SYNC_IAH: Last Sync to info@hand
...
LBL_GOOGLE_DOMAIN_EXPLANATION:
	Your Google App Domain. If you access Google Applications using your own domain name, the domain name must be entered in the field above. If you are using standard domain <i>google.com</i>, leave this field blank
