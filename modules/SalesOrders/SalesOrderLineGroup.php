...
require_once('modules/SalesOrders/SalesOrderLine.php');
require_once('modules/SalesOrders/SalesOrderAdjustment.php');
require_once('modules/SalesOrders/SalesOrderComment.php');

require_once('modules/Quotes/QuoteLineGroup.php');

class SalesOrderLineGroup extends QuoteLineGroup {
	...
	var $object_name = 'SalesOrderLineGroup';
	var $table_name = 'sales_order_line_groups';
	var $new_schema = true;
	//
	var $line_object = 'SalesOrderLine';
	var $comment_object = 'SalesOrderComment';
	var $adj_object = 'SalesOrderAdjustment';
	var $rel_id_field = 'sales_orders_id';
	...
	function SalesOrderLineGroup() {
		parent::QuoteLineGroup();
	}
	
	function &newForParent(&$bean) {
		$ilg = new SalesOrderLineGroup();
