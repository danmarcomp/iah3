...
require_once('modules/Bills/BillLine.php');
require_once('modules/Bills/BillAdjustment.php');
require_once('modules/Bills/BillComment.php');

require_once('modules/Quotes/QuoteLineGroup.php');

class BillLineGroup extends QuoteLineGroup {
	...
	var $object_name = 'BillLineGroup';
	var $table_name = 'bill_line_groups';
	var $new_schema = true;
	//
	var $line_object = 'BillLine';
	var $comment_object = 'BillComment';
	var $adj_object = 'BillAdjustment';
	var $rel_id_field = 'bills_id';
