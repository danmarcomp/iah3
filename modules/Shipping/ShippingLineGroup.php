...
require_once('modules/Shipping/ShippingLine.php');
require_once('modules/Shipping/ShippingAdjustment.php');
require_once('modules/Shipping/ShippingComment.php');

require_once('modules/Quotes/QuoteLineGroup.php');

class ShippingLineGroup extends QuoteLineGroup {
	...
	var $object_name = 'ShippingLineGroup';
	var $table_name = 'shipping_line_groups';
	var $new_schema = true;
	//
	var $line_object = 'ShippingLine';
	var $comment_object = 'ShippingComment';
	var $adj_object = 'ShippingAdjustment';
	var $rel_id_field = 'shipping_id';
	...
	function ShippingLineGroup() {
		parent::QuoteLineGroup();
	}
	
	function &newForParent(&$bean) {
		$ilg = new ShippingLineGroup();
