...
$xtpl = new XTemplate('modules/Invoice/PopupCardRefund.html');
...
if (!empty($_REQUEST['do_process'])) {
	...
	if (Pear::isError($result)) {
		...
		if ($success) {
			...
			echo '<script type="text/javascript">window.opener.location.href="index.php?module=Payments&action=DetailView&record=' . $payment->id . '"; window.close(); </script>';
			exit;
		}
	}
}
