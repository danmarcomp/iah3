...
require_once('modules/CreditNotes/CreditNoteLine.php');
require_once('modules/CreditNotes/CreditNoteAdjustment.php');
require_once('modules/CreditNotes/CreditNoteComment.php');

require_once('modules/Quotes/QuoteLineGroup.php');

class CreditNoteLineGroup extends QuoteLineGroup {
	...
	var $object_name = 'CreditNoteLineGroup';
	var $table_name = 'credits_line_groups';
	var $new_schema = true;
	//
	var $line_object = 'CreditNoteLine';
	var $comment_object = 'CreditNoteComment';
	var $adj_object = 'CreditNoteAdjustment';
	var $rel_id_field = 'credit_id';
	...
	function CreditNoteLineGroup() {
		parent::QuoteLineGroup();
	}
	
	function &newForParent(&$bean) {
		$ilg = new CreditNoteLineGroup();
