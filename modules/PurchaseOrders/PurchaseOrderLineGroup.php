...
require_once('modules/PurchaseOrders/PurchaseOrderLine.php');
require_once('modules/PurchaseOrders/PurchaseOrderAdjustment.php');
require_once('modules/PurchaseOrders/PurchaseOrderComment.php');

require_once('modules/Quotes/QuoteLineGroup.php');

class PurchaseOrderLineGroup extends QuoteLineGroup {
	...
	var $object_name = 'PurchaseOrderLineGroup';
	var $table_name = 'purchase_order_line_groups';
	var $new_schema = true;
	//
	var $line_object = 'PurchaseOrderLine';
	var $comment_object = 'PurchaseOrderComment';
	var $adj_object = 'PurchaseOrderAdjustment';
	var $rel_id_field = 'purchase_orders_id';
	...
	function PurchaseOrderLineGroup() {
		parent::QuoteLineGroup();
	}
	
	function &newForParent(&$bean) {
		$ilg = new PurchaseOrderLineGroup();
