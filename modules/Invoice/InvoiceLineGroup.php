...
require_once('modules/Invoice/InvoiceComment.php');

require_once('modules/Quotes/QuoteLineGroup.php');

class InvoiceLineGroup extends QuoteLineGroup {
	...
	var $object_name = 'InvoiceLineGroup';
	var $table_name = 'invoice_line_groups';
	var $new_schema = true;
	//
	var $line_object = 'InvoiceLine';
	var $comment_object = 'InvoiceComment';
	var $adj_object = 'InvoiceAdjustment';
	var $rel_id_field = 'invoice_id';
