...
MSG_IMPORT_GREETINGS:
	Here you can import competitive CRM data (in a series of CSV files) into info@hand, and then manage the imported data.<br />This facilitates (for Clients or Partners) a database migration when clients upgrade to info@hand from other CRM products.<br />Additional import profiles may be added upon request.
