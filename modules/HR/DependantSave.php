...
$model = new ModelDef('EmployeeDependant');
$fields = array('id', 'employee_id', 'first_name', 'last_name', 'dob', 'relationship');
...
return array('perform', array('module' => 'HR', 'action' => 'DetailView', 'record' => $_REQUEST['employee_id'], 'record_perform' => 'view', 'layout' => 'Standard'));
?>
