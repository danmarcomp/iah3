<?php
	...
	function calculate_holiday($year, $month, $day)  {
		...
		// +
		if ($month == 1 && $day == 1) {
			return "LBL_HDY_CH_NEUJAHR";
		} # Neujahrstag

		// +
		if ($month == 1 && $day == 2) {
			return "LBL_HDY_CH_BERCHTOLDS";
		} # Berchtoldstag

		// +
		if ($month == 1 && $day == 6) {
			return "LBL_HDY_CH_DREIKOENIG";
		} # Heilige drei Kšnige

		// +
		if ($month == 2 && $day == 14) {
			return "LBL_HDY_CH_VALENTINE";
		} # Valentinstag

		// +
		if  (easter_relative($year, $month, $day, -7)) {
			return 'LBL_HDY_CH_PALMSONNTAG';
		} # Palmsonntag

		// +
		if  (easter_relative($year, $month, $day, -2)) {
			return 'LBL_HDY_CH_KARFREITAG';
		} # Karfreitag

		// +
		if  (easter_relative($year, $month, $day, 0)) {
			return 'LBL_HDY_CH_OSTERN';
		} # Ostern

		// +
		if  (easter_relative($year, $month, $day, 1)) {
			return 'LBL_HDY_CH_OSTERMONTAG';
		} # Ostermontag

		// +
		if ($month == 5 && $day == 1) {
			return "LBL_HDY_CH_TAGDERARBEIT";
		} # Tag der Arbeit

		// +
		if ($month == 5 && $day > 7 && $day <= 14 && $weekday == 0) {
			return "LBL_HDY_CH_MUTTERTAG";
		} # Muttertag

		// +
		if  (easter_relative($year, $month, $day, 39)) {
			return 'LBL_HDY_CH_AUFFAHRT';
		} # Auffahrt

		// +
		if  (easter_relative($year, $month, $day, 49)) {
			return 'LBL_HDY_CH_PFINGSTEN';
		} # Pfingsten

		// +
		if  (easter_relative($year, $month, $day, 50)) {
			return 'LBL_HDY_CH_PFINGSTMONTAG';
		} # Pfingstmontag

		// +
		if  (easter_relative($year, $month, $day, 60)) {
			return 'LBL_HDY_CH_FRONLEICHNAM';
		} # Fronleichnam

		// +
		if ($month == 8 && $day == 1) {
			return "LBL_HDY_CH_NATIONALFEIERTAG";
		} # Nationalfeiertag Schweiz

		//+
		if ($month == 8 && $day == 15) {
			return "LBL_HDY_CH_MARIAHIMMELFAHRT";
		} # MariŠ Himmelfahrt

		// +
		if ($month == 9 && $day > 14 && $day <= 21 && $weekday == 0) {
			return "LBL_HDY_CH_BUSSUNDBETTAG";
		} # Eidg. Dank-, Buss- und Bettag

		//+
		if ($month == 11 && $day == 1) {
			return "LBL_HDY_CH_ALLERHEILIGEN";
		} # Allerheiligen

		//+
		if ($month == 12 && $day == 8) {
			return "LBL_HDY_CH_MARIAEEMPFAENGNIS";
		} # MariŠ EmpfŠngnis

		// +
		if (advent4_relative($year, $month, $day, -21)) {
			return "LBL_HDY_CH_ADVENT1";
		} # Erster Advent Vierter Sonntag vor Weihnachten

		// +
		if (advent4_relative($year, $month, $day, -14)) {
			return "LBL_HDY_CH_ADVENT2";
		} # Zweiter Advent Dritter Sonntag vor Weihnachten

		// +
		if (advent4_relative($year, $month, $day, -7)) {
			return "LBL_HDY_CH_ADVENT3";
		} # Dritter Advent  Zweiter Sonntag vor Weihnachten

		// +
		if (advent4_relative($year, $month, $day, 0)) {
			return "LBL_HDY_CH_ADVENT4";
		} # Vierter Advent  Sonntag vor Weihnachten

		// +
		if ($month == 12 && $day == 24) {
			return "LBL_HDY_CH_HEILIGABEND";
		} # Heiliger Abend

		// +
		if ($month == 12 && $day == 25) {
			return "LBL_HDY_CH_WEIHNACHTEN";
		} # Weihnachten

		// +
		if ($month == 12 && $day == 26) {
			return "LBL_HDY_CH_STEPHANSTAG";
		} # Stephanstag

		// +
		if ($month == 12 && $day == 31) {
			return "LBL_HDY_CH_SILVESTER";
		} # Silvester
