...
ERROR_FLAVOR_INCOMPATIBLE: The uploaded file is not compatible with this flavor of info@hand
...
ERROR_VERSION_INCOMPATIBLE: The uploaded file is not compatible with this version of info@hand
...
LBL_DIAGNOSTIC_SUGARLOG: info@hand Log File
...
LBL_HT_DONE: "--- DONE ---"
LBL_HT_NO_WRITE_2:
	If you want to secure your files from being accessible via browser, create an .htaccess file in your root directory with the lines
...
LBL_MODULE_LOADER: Add or remove info@hand modules, themes, or language packs
LBL_NEVER: Never
...
LBL_MAINTAIN: Check and repair info@hand CRBM
...
LBL_UPGRADE_CREDIT_NOTES_DESC: Upgrade Credit Notes to info@hand 6.6.0 format
...
LBL_UPGRADE_CUSTOMERS_VENDORS_DESC:
	Since info@hand 6.5.0, the same Account cannot be used as both a Customer and Supplier. This upgrade task finds Accounts used as both Customer and Supplier, and creates a new Supplier Account. Purchase activities are moved to this new Account
...
LBL_UPGRADE_CURRENCY_DESC: Upgrade default currency to info@hand 7.0
LBL_UPGRADE_MODULES_TABLES: Upgrade Modules Data
LBL_UPGRADE_MODULES_TABLES_DESC: Upgrade modules db data to info@hand 7.0
