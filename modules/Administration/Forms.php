...
// longreach -- this does not exist in Sugar??
function get_confsettings_js($category) {
	global $mod_strings;
	global $app_strings;
...
var forecasts_warned = false;
function notify_forecasts_erased()
{
	if(!forecasts_warned)
		alert('{$mod_strings['LBL_FORECASTS_ERASED']}');
	forecasts_warned = true;
}
// --></script>
EOQ;
}
